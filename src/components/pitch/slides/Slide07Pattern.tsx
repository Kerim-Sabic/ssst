...
export function Slide07Pattern() {
  return (
    <Slide>
      <Kicker className="mb-4">Pattern detection</Kicker>
      <WordReveal
      ...
      <div className="mt-9 grid items-center gap-8 lg:grid-cols-[1fr_auto_1fr]">
        ...
        <div className="relative hidden h-48 w-28 lg:block">
          <svg viewBox="0 0 112 192" className="h-full w-full" fill="none" aria-hidden>
            {/* draw-in guide */}
            <motion.path
            ...
            <motion.path
              ...
              transition={{
                ...
                strokeDashoffset: { delay: 1.8, duration: 1.4, ease: "linear", repeat: Infinity },
              }}
            />
            <motion.path
        ...
        <div className="relative">
          ...
          />
          <RiskCard level="red" title="Concerning worsening pattern" delay={2} />
        </div>
      </div>
